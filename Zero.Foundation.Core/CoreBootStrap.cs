...
namespace Zero.Foundation
{
    public class CoreBootStrap : IBootStrap
    {
        ...
        public virtual void OnBeforePluginsLoaded(IFoundation foundation)
        {
            foreach (IBootStrap item in BootStrapChain)
            {
                item.OnBeforePluginsLoaded(foundation);
            }
        }
        ...
        public virtual void OnBeforeBootStrapComplete(IFoundation foundation)
        {
            foreach (IBootStrap item in BootStrapChain)
            {
                item.OnBeforeBootStrapComplete(foundation);
            }
        }
